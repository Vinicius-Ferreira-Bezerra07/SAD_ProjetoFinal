...
st.title("Histograma de alunos divididos por curso")
...
st.title("Histograma de alunos que abandonaram as aulas por curso")
...
# Base da dados apenas com os estudantes que Abandonaram o Curso
st.title("Histograma de alunos que se graduaram por curso")
